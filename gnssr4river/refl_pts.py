# -*- coding: utf-8 -*-
"""
To compute and show reflexion points for GNSS-R
Lubin Roineau, ENSG, Aug 05, 2022
"""
...
def plotEllipse(a,b,R,azim):
    ...
    R_rot = np.array([[np.cos(rot) , -np.sin(rot)],[np.sin(rot) , np.cos(rot)]])    #Rotation matrix
